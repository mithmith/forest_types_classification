...
class SKResNeXt50_PSPNet_NIR(nn.Module):
    def __init__(self, num_classes: int, freeze_encoder: bool = False, pool_sizes=(1, 2, 3, 6)):
        super(SKResNeXt50_PSPNet_NIR, self).__init__()
